...
(function () {
  ...
  var filterPullDownnrs = function()
  {
      
         //alert('clicked'); 
         var patid=$('#patid1').val();
        // alert(patid)
         $('#apptdtls').load("patientapptdetailsfetch.jsp?patid="+patid);
 // $('#patientdetailsin').show();
   //   location.reload();
  //alert(reload)
 ...
 //     $('#patientsearchdiv').show();
    ...
    var flag = false;
    $(".businessTypePullDownnrs").click(function () {
        if (flag) {
            filterPullDownnrs()
        }
        flag = !flag;
    ...
    $(".businessTypePullDownnrs").focusout(function () {
        flag = false;
    });
}());
...
$("#apptblock").load(location.href + " #apptblock");           
 
 });
 
 
 
   $("#nrbookappointment").click(function(){
        alert("clckd");
        var patid=$('#patid').val();
         var docdets=$('#docdetailpulldwn').val();
          var apptdate=$('#aptday').val();
          var timeslot=$('#timeslot').val();
          //alert(docdets +" "+ apptdate+" "+timeslot);
$('#appointmntstatus1').load("createappointmentnr.jsp?patid="+patid+"&docdtls="+docdets+"&dateofapt="+apptdate+"&timeslotid="+timeslot); 
        
      //  $('#appointmntstatus1').load("createappointment.jsp?docdtls="+docdets+"&dateofapt="+apptdate+"&timeslotid="+timeslot);   
        
   // $('#patientdetailsin').load("patientdetailsfetch.jsp");
    });
