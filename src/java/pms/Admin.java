...
public class Admin extends Employee{
    ...
    public Admin( String Employee_Id)
    {
        super(Employee_Id);
    }
  public Admin()
  {}
   ...
   // public HashMap<String,String> getDetails()
    public void getDetails()
    {
        ...
        BAL bal=new BAL();
        HashMap<String,String> AdminDetails=bal.getAllempdetails(get_EmployeeID());
...
public ResultSet getadmdetails()
    {
    BAL bal1=new BAL();
    ResultSet admdetails=bal1.getadmindetailds();
    return admdetails;
